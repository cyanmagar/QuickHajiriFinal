    ...
    >
      <div className="p-4 relative">
        ...
        <div className="flex flex-col space-y-3">
          {[
            { src: DashboardIcon, label: 'Dashboard', to: '/teacher/dashboard' },
            { src: Manageteacher, label: 'View Request', to: '/teacher/view-request' },
            { src: Managefaculty, label: 'Take Attendance', to: '/teacher/take-attendance' },
            { src: Upgradesemester, label: 'Attendance Records', to: '/teacher/attendance-records' },
